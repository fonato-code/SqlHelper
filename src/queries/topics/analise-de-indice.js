(function (root) {
  ...
  SqlHelp._qt_analise_de_indice = {
    ...
    blocks: [
      { type: 'md', content: `
		Para analisar os indices em relação a performance precisamos validar se os indices são realmente utilizados,  se existem somente para pesar nos updates, se exitem indices duplicados desnecessarios que pesam em update .
      ...
      { type: 'sql', title: `Analise completa dos indices`, sql: `;with cte as  (
			...
			ORDER BY
				...
				PercentUse ASC;` },
      { type: 'md', content: `
		## Querie que retorna indices que tem exatamente a mesma quantidade de Leituras e updates
      ...
      { type: 'sql', title: `Query 2`, sql: `
		SELECT	c-ip AS IP_Origem,
